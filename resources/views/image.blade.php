...
<div class="container">
    ...
    <p class="lead">Make Sure To Select A Section For Image To Appear</p>
    <!-- Upload  -->
    <form id="file-upload-form" class="uploader" action="{{url('save')}}" method="post" accept-charset="utf-8"
